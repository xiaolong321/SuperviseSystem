    ...
    <div id="p" class="easyui-panel panel-body" title="" width: 680px; height: 100%;
        ...
        <form class="form-layout">
            ...
            <div class="preview-set-panel" style="width:680px;">
                <div class="left">
                    <img id="image" src="/uploads/images/headicon/headicon.jpg"
                         onerror="javascript:this.src='/uploads/images/headicon/headicon.jpg';" alt="Picture">
                </div>
                <div class="right">
